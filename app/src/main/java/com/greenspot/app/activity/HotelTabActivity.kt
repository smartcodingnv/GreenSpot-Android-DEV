...
import com.greenspot.app.responce.hoteldetails.AmenitiesItem
import com.greenspot.app.responce.hoteldetails.ResponceHotelDetails
import com.greenspot.app.utils.*
import kotlinx.android.synthetic.main.activity_hotel_tab.*
import java.util.*

class HotelTabActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        txt_hotelname.text = hoteldetails.data.mainRecords.name
...
//        tab!!.select()
        ...
        val adapter = HotelTabAdapter(this, supportFragmentManager, tabLayout!!.tabCount)
