...
data class Availability(@SerializedName("address")
                        val address: String = "",
...
data class AmenitiesRecordsItem(@SerializedName("records")
...
data class Description(@SerializedName("description")
                       val description: String = "")


data class OtherRecordsItem(@SerializedName("id")
                            val id: Int = 0,
                            @SerializedName("title")
                            val title: String = "",
                            @SerializedName("value")
...
data class Payments(@SerializedName("payment_records")
...
data class OtherItem(@SerializedName("id")
                     val id: Int = 0,
                     @SerializedName("title")
                     val title: String = "",
                     @SerializedName("value")
...
data class ResponceRecDetails(@SerializedName("data")
                              val data: Data,
...
data class MainRecords(@SerializedName("place_name")
                       val placeName: String = "",
                       @SerializedName("country")
                       val country: String = "",
...
data class PaymentRecordsItem(@SerializedName("records")
                              var records: List<RecordsItem>?,
                              @SerializedName("id")
                              val id: Int = 0,
                              @SerializedName("title")
...
data class SocialLinksItem(@SerializedName("master_id")
                           val masterId: String = "",
...
data class Amenities(@SerializedName("other_activities")
