...
import com.greenspot.app.responce.hoteldetails.GalleryImagesItem


import kotlinx.android.synthetic.main.item_placeimg.view.*
import java.util.*

class SliderHotelAdapter(val context: FragmentActivity?) :
    RecyclerView.Adapter<SliderHotelAdapter.FeatureViewHolder>() {
