...
import com.greenspot.app.responce.bookinginforecreation.AmenitiesItem

import com.greenspot.app.utils.Common
import java.util.*

class BookingVacationAminitesTitleAdapter(val context: FragmentActivity?) :
    RecyclerView.Adapter<BookingVacationAminitesTitleAdapter.FeatureViewHolder>() {
    ...
    class FeatureViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(
            ...
            val placeDetailsAdapter = BookingVcationAminitesDetailsAdapter(context)
