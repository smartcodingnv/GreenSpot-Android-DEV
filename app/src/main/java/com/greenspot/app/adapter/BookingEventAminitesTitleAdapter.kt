...
class BookingEventAminitesTitleAdapter(val context: FragmentActivity?) :
    RecyclerView.Adapter<BookingEventAminitesTitleAdapter.FeatureViewHolder>() {

    private var data: List<EventAmenitiesItem> = ArrayList()
    ...
    fun swapData(data: List<EventAmenitiesItem>) {
        this.data = data
