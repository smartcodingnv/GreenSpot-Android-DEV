...
import com.greenspot.app.responce.bookinginforecreation.RecordsItem
import java.util.*

class BookingVcationAminitesDetailsAdapter(val context: FragmentActivity?) :
    RecyclerView.Adapter<BookingVcationAminitesDetailsAdapter.FeatureViewHolder>() {
