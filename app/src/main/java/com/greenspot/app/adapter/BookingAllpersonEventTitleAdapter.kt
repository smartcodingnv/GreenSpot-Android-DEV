...
import com.greenspot.app.responce.bookinginfoevent.AllUsersInfoItem
import java.util.*

class BookingAllpersonEventTitleAdapter(val context: FragmentActivity?) :
    RecyclerView.Adapter<BookingAllpersonEventTitleAdapter.FeatureViewHolder>() {
    ...
    class FeatureViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(
            ...
            if (item.firstName.isNotEmpty() && item.lastName.isNotEmpty()) {
                ...
                itemView.findViewById<TextView>(R.id.txt_name).text =
                    context.getString(R.string.res_na)
            }

            if (item.dob.isNotEmpty()) {
                itemView.findViewById<TextView>(R.id.txt_dob).text = item.dob
            } else {
                itemView.findViewById<TextView>(R.id.txt_dob).text =
                    context.getString(R.string.res_na)
            }

            if (item.gender.isNotEmpty()) {
                itemView.findViewById<TextView>(R.id.txt_gender).text = item.gender
            } else {
                itemView.findViewById<TextView>(R.id.txt_dob).text =
                    context.getString(R.string.res_na)
            }
            ...
            if (item.gender.isNotEmpty()) {
                ...
                itemView.findViewById<TextView>(R.id.txt_email).text =
                    context.getString(R.string.res_na)
            }
            ...
            if (item.gender.isNotEmpty()) {
                ...
                itemView.findViewById<TextView>(R.id.txt_contactno).text =
                    context.getString(R.string.res_na)
            }
