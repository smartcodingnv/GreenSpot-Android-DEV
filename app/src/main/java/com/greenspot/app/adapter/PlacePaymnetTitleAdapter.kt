...
class PlacePaymnetTitleAdapter(val context: FragmentActivity?) :
    RecyclerView.Adapter<PlacePaymnetTitleAdapter.FeatureViewHolder>() {

    private var data: List<PaymentRecordsItem> = ArrayList()
    ...
    fun swapData(data: List<PaymentRecordsItem>) {
        this.data = data
