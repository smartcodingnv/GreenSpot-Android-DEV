...
import com.greenspot.app.responce.bookinginforecreation.StayItem
import com.greenspot.app.utils.Common
import java.util.*

class BookingPlaceStayTitleAdapter(val context: FragmentActivity?) :
    RecyclerView.Adapter<BookingPlaceStayTitleAdapter.FeatureViewHolder>() {
