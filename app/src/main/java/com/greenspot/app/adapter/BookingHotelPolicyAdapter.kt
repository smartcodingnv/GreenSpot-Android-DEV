...
import com.greenspot.app.responce.bookinginfohotel.RecordsItem


import java.util.*

class BookingHotelPolicyAdapter(val context: FragmentActivity?) :
    RecyclerView.Adapter<BookingHotelPolicyAdapter.FeatureViewHolder>() {
