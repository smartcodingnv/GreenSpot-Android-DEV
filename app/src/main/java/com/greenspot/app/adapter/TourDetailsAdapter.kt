...
class TourDetailsAdapter(val context: FragmentActivity?) :
    RecyclerView.Adapter<TourDetailsAdapter.FeatureViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FeatureViewHolder {
        return FeatureViewHolder(
            LayoutInflater.from(parent.context)
                .inflate(R.layout.item_tourdetailslist_item, parent, false)
        )
    }
